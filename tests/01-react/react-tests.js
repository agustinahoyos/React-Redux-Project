    ...
    describe('Message', () => {
        ...
        describe('contenido visual', () => {
            ...
            beforeEach('Crea un wrapper para <Message /> ', () => {
                messageData = {
                    id: 5,
                    from: {email: 'emi@soyhenry.com'},
                    to: {email: 'toni@soyhenry.com'},
            ...
            it('incluye el "FROM" como un h1', () => {
                expect(messageWrapper.find('h1')).to.have.html('<h1>From: <span>emi@soyhenry.com</span></h1>');
            });

            it('incluye el "TO" como un h2', () => {
                expect(messageWrapper.find('h2')).to.have.html('<h2>To: <span>toni@soyhenry.com</span></h2>');
            });
            ...
            it('no esta harcodeado', () => {
                const aDifferentMessage = {
                    id: 6,
                    from: {email: 'toni@soyhenry.com'},
                    to: {email: 'emi@soyhenry.com'},
                ...
                expect(differentMessageWrapper.find('h1')).to.have.html('<h1>From: <span>toni@soyhenry.com</span></h1>');
                expect(differentMessageWrapper.find('h2')).to.have.html('<h2>To: <span>emi@soyhenry.com</span></h2>');
    ...
    describe('NewMessageForm', () => {
        ...
        beforeEach('Crea <NewMessageForm /> wrapper', () => {
         ...
         it('setea el estado local cuando el input cambia', () => {
            ...
            recipientInput.simulate('change', {target: {value: 'facu@soyhenry.com', name: 'recipient'}});
            // El estado debería haber actualizado su estado correctamente
            expect(newMessageFormWrapper.state()).to.have.property('recipient', 'facu@soyhenry.com')
        ...
        describe('EXTRA CREDITO', () => {
            ...
            describe('conexión del componente', () => {
                ...
                describe('<Inbox />', () => {
                    ...
                    it('tiene un estado local inicial que refleja el estado actual del store', () => {
                    ...
                    it('se subscribe a cambios del store de redux y siempre refleja el estado de forma correcta', () => {
